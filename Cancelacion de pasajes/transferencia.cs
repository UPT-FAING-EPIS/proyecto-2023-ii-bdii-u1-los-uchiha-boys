...
namespace Cancelacion_de_pasajes
{
    public partial class transferencia : Form
    {
        ...
        public transferencia(int idCliente)
        {
            InitializeComponent();
        ...
        private void CargarDatos()
        {
            ...
            try
            {
                ...
                {
                    txt123.Text = idClienteSeleccionado.ToString();
                }
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex == dgv_datos.Columns["SeleccionarViaje"].Index)
            {
                if (dgv_datos.Rows[e.RowIndex].Cells["IDPasaje"].Value != null)
                {
                    if (dgv_datos.Rows[e.RowIndex].Cells["IDCliente"].Value != null)
                    {
                        ...
                        transferencia_seleccionar transferencia_seleccionarForm = new transferencia_seleccionar();
                        transferencia_seleccionarForm.idCliente123 = idCliente123;
                        transferencia_seleccionarForm.idCliente456 = idCliente456;



                        transferencia_seleccionarForm.ShowDialog();
                        tablaOriginal = null;
                        Close();
                    }
